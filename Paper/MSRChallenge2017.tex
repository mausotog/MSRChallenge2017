...
equal, a process known as downsampling.  We train on the down-sampled data but show results on both 
downsampled and non-downsampled data sets.\todo{CLG says: that last sentence is
  true, right?}
...
Our results might not generalize to 
 ...
 incorrect test cases and not low quality contributions.\todo{...and?  Something
   like ``future work remains to assess the degree of these threats'' will do.}
