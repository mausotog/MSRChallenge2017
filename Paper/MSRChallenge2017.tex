...
F-score is a correlation\todo{this is not true; please correct} of these two values. We can see that all these measures increase when we add social data into the feature space, making the prediction more reliable. Besides this, the mean absolute error
