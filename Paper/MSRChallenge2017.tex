...
between a developer's followers and build integration success.
...
F-score is a correlation\todo{this is not true; please correct.  Also, we really
don't have the space to include precision/recall formulae, given that they're
well-known; correct your understanding, then delete this comment and the formulae} of these two values. We can see that all these measures increase when we add social data into the feature space, making the prediction more reliable. Besides this, the mean absolute error
...
Social attributes proxying experience, such as whether
...
Overall, although experience is an imperfect indicator, but
