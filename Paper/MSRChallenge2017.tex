...
% 
\author{\IEEEauthorblockN{Zack Coker,
Mauricio Soto and
Claire Le Goues}
\IEEEauthorblockA{School of Computer Science\\
Carnegie Mellon University,
Pittsburgh PA\\ 
zfc@cs.cmu.edu, mauriciosoto@cmu.edu, clegoues@cs.cmu.edu}
} 
...
success decreases~\cite{Kwan11}. Another investigation used a dataset from the
same project and
