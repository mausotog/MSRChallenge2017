...
\paragraph{Comparing two data sets:} We used the social data\todo{Confusing,
  since you proceed to say you build a dataset with technical factors as well as
  social factors.} gathered to create two data 
...
significantly in the last three years.\todo{Why?}
...
The high ratio of successful to not successful builds leads a naive classifier to 
favor misclassifying not successful\todo{everywhere you say ``not successful'',
  replace with ``unsuccessful''.} builds over successful builds, because a 1\%
...
\todo{Maybe ``relationship with'' rather than ``effect on''?
...
Overall, we have found that social attributes which proxy experience\todo{, such
  as, example,} produce a 
